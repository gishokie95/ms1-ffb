...
##R code for plotting time series of time-integrated thermocouple probe heating
...
##calculate averages for individual burns (x4 ds, x3 gs)##
...
plot.dose.burn <- ggplot() +
  ...
  #define alpha transparency values
  ...
  #set continuous x-axis scale with defined breaks
...
plot.dose.burn
#save to file
png("output/figures/ms 1/fig7_mean_heatdose_time_trt.png",
    width = 6.5,
    height = 5,
    units = "in",
    res = 600)
